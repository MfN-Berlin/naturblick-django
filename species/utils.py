...
def map_species(all_synonyms):
    return lambda s: (
        ...
        get_synonyms(all_synonyms, 'en', s.id), s.red_list_germany, s.iucncategory, s.speciesid,
