    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('gerdescription', models.TextField(blank=True, null=True)),
                ('engdescription', models.TextField(blank=True, null=True)),
            ],
            options={
                'db_table': 'character',
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(primary_key=True, serialize=False)),
                ('name', models.CharField(choices=[('sound_recogniotion_images', 'Lauterkennung Bilder'), ('sound_recogniotion_sounds', 'Lauterkennung Tonaufnahmen'), ('ident_keys', 'Bestimmungsschlüssel')], max_length=32)),
                ('scie_name', models.CharField(max_length=255)),
                ('scie_name_eng', models.CharField(blank=True, max_length=255, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('gername', models.CharField(blank=True, db_index=True, max_length=255, null=True)),
                ('sciname', models.CharField(db_index=True, max_length=255, unique=True)),
                ('engname', models.CharField(blank=True, db_index=True, max_length=255, null=True)),
