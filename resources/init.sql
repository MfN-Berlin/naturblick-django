...
insert into species (id, speciesid, gername, sciname, engname, nbclassid, wikipedia, autoid, red_list_germany, iucncategory ,activity_start_month ,activity_end_month, activity_start_hour, activity_end_hour, gbifusagekey, accepted_species_id, created_at, updated_at, avatar_id, group_id)
select s.id, s.speciesid, s.gername, s.sciname, s.engname, s.nbclassid, s.wikipedia, s.autoid, s."redListGermany", s.iucncategory, s."activityStartMonth", s."activityEndMonth", s."activityStartHour", s."activityEndHour", s.gbifusagekey, s.accepted, s.created_at, s.updated_at, a.id, g.id
